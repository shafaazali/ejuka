      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center mb-5">
            <h2 class="text-black">Login to</h2><h1 style="font-family: Agency FB">EJUKA</h1>
          </div>
        </div>
            ...
            <form action="login.php" method="post">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input type="text" name="username" id="" class="form-control" placeholder="User Name"  required="required">
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="password" name="password" id="" class="form-control" placeholder=" Password"  required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-12 mr-auto">
                  <input type="submit" class="btn btn-block btn-primary"></div></div>
                  <div class="form-group row">
                <div class="col-md-6">
                  <a href="signup.php" class="site-navbar">Create a New Account ? </a>
                </div>
              </div>
            </form>
          </div>
