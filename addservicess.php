...
if(isset($_POST['submit']))
{
	...
	$b = $_POST['description'];
		...
		// query
		$sql = "INSERT INTO services(Sevices,Description) VALUES (:a,:b)";
		$q = $db->prepare($sql);
...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Add Services
			</div>
			<ul class="breadcrumb">
...
<tr>
    <td>Image</td><td><textarea name="description" rows="4" cols="30"></textarea></td>
</tr>
