...
if(isset($_POST['sub']))
{
  ...
  $msg=$_POST['msg'];
  $qr="insert into ask_question(User_id,question) values ($id,'$msg') ";
  mysqli_query($link,$qr) or die($qr);
  header("Location:ask.php?ms=added");
}
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <!--<li><a href="#services-section" class="nav-link">Notification</a></li>
                <li><a href="#services-section" class="nav-link">Events</a></li>
                <li class="has-children">
               <a href="#services-section" class="nav-link">Gallary</a>
                <ul class="dropdown">
                    <li><a href="#training-section" class="nav-link">Images</a></li>
                    <li><a href="#testimonials-section" class="nav-link">Videos</a></li>
                </ul>
                </li>
                <li class="has-children">
          ...
          if(mysqli_num_rows($result_not1) > 0) 
            {
                ...
                {
            ?>
                    <li><a href="" class="nav-link"><?php echo $not1['Sevices']; ?></a></li>
...
{
?>
<!-- <li><a href="#training-section" class="nav-link">Ask a Doubt</a></li>
<li><a href="#services-section" class="nav-link">Request for council</a></li> 
<li><a href="#services-section" class="nav-link">Feedback</a></li>
<li><a href="#" class="nav-link">Start Exam</a></li> -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center mb-5">
            <h2 class="text-black">Ask a doubt</h2>
          </div>
        </div>
            ...
            <form action="" method="post">
              ...
              <div class="form-group row">
                <div class="col-md-12 mr-auto">
                  <input type="submit" class="btn btn-block btn-primary " name="sub" value="Send Message"> <?php
    if(isset($_GET['ms']))
 {
  echo "<p>".$_GET['ms'] ."</p>";
 }
