...
if(isset($_POST['sub']))
{
  ...
  $email=$_POST['email'];
  $msg=$_POST['msg'];
  $qr="insert into free_council(name,phone,email,description,R_date) values ('$name','$phone','$email','$msg',CURDATE()) ";
  mysqli_query($link,$qr) or die($qr);
  header("Location:request.php?ms=added");
}
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center mb-5">
            <h2 class="text-black">Request for free council</h2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12 mb-5">
            <form action="" method="post">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <textarea name="msg" id="" class="form-control" placeholder="Write your message." cols="30" rows="10" required="required"></textarea>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-12 mr-auto">
                  <input type="submit" class="btn btn-block btn-primary " name="sub" value="Send request"> <?php
    if(isset($_GET['ms']))
 {
  echo "<p>".$_GET['ms'] ."</p>";
 }
