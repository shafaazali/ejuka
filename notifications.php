    ...
    <section class="site-blocks-cover overflow-hidden">
     ...
     <section class="site-section" id="about-section">
      ...
      <?php if(isset($_GET['id'])){?>
        ...
        $id=$_GET['id'];
          $qry_n="SELECT * FROM notification where N_id = $id"; 
          ...
          <div class="col-12 mb-3">
            <h2 class="text-black"><?php echo $not1['Title'];?></h2>
          </div>
          <div class="col-md-6 mb-5"><p><?php echo $not1['Description'];?></p>
            <p class="mt-5"><?php echo $not1['N_date'];?> - <?php echo $not1['Time'];?></p>
          </div>
          <?php }?>
...
<div class="col-12 mb-3">
          <h2 class="text-black mb-4 h6">Notifications </h2> 
      ...
      if(mysqli_num_rows($result_not) > 0) 
      {
        while($not = mysqli_fetch_assoc($result_not))
        {
            ...
            <a href="notifications.php?id=<?php echo $not['N_id'];?>">  <li class="mb-4">
                ...
                <span class="text-muted"><?php echo substr($not['Description'],0,50)."....";?></span>
              </li>
              </a>
             <?php
            }
