    ...
    <section class="site-section" id="gallery-section">
      ...
      if(mysqli_num_rows($result_envts) > 0) 
      {
        while($not_envts = mysqli_fetch_assoc($result_envts))
        {
          $img=$not_envts['G_url'];
            ?>
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="main/gallery/<?php echo $img;?>" data-fancybox="gal"><img src="main/gallery/<?php echo $img;?>" alt="Free Website Template by Free-Template.co" class="img-fluid" height="100" width="150"></a>
